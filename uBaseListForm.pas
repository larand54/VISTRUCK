...
uses
  ...
  dxSkinsdxBarPainter, siComp, siLngLnk, System.Actions ;
...
type
  TfBaseListForm = class(TForm)
    ...
    siLangLinked_fBaseListForm: TsiLangLinked;
...
procedure TfBaseListForm.cds_PropsAfterInsert(DataSet: TDataSet);
begin
