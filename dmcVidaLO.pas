...
type
  TdmcLO = class(TDataModule)
    sq_LO1: TSQLQuery;
    dsp_LO1: TDataSetProvider;
    cds_LO1: TClientDataSet;
    ds_IntHdr: TDataSource;
    ds_LO: TDataSource;
    cds_LO1SupplierShipPlanObjectNo: TIntegerField;
    cds_LO1CustShipPlanDetailObjectNo: TIntegerField;
    cds_LO1ShipType: TIntegerField;
    cds_LO1ObjectType: TIntegerField;
    cds_LO1OrderNo: TIntegerField;
    cds_LO1OrderLineNo: TIntegerField;
    cds_LO1ShippingPlanNo: TIntegerField;
    cds_LO1SupplierNo: TIntegerField;
    cds_LO1LoadingLocationNo: TIntegerField;
    cds_LO1DeliveryTermsNo: TIntegerField;
    cds_LO1PaymentTermsNo: TIntegerField;
    cds_LO1Price: TFloatField;
    cds_LO1CurrencyNo: TIntegerField;
    cds_LO1NoOfUnits: TFloatField;
    cds_LO1PriceUnitNo: TIntegerField;
    cds_LO1VolumeUnitNo: TIntegerField;
    cds_LO1DestinationNo: TIntegerField;
    cds_LO1ShippingPlanStatus: TIntegerField;
    cds_LO1StartETDYearWeek: TIntegerField;
    cds_LO1EndETDYearWeek: TIntegerField;
    cds_LO1InternalNote: TStringField;
    cds_LO1ProductDescription: TStringField;
    cds_LO1LengthDescription: TStringField;
    cds_LO1AcceptedBySupplier: TIntegerField;
    cds_LO1ProductLengthNo: TIntegerField;
    cds_LO1ProductGroupNo: TIntegerField;
    cds_LO1ActualM3Net: TFloatField;
    cds_LO1ShipToInvPointNo: TIntegerField;
    cds_LO1ProductNo: TIntegerField;
    cds_LO1LOText: TMemoField;
    cds_LO1MinActualLengthMM: TFloatField;
    cds_LO1MaxActualLengthMM: TFloatField;
    cds_LO1PackageCode: TStringField;
    cds_LO1FreightOrderByClientNo: TIntegerField;
    cds_LO1SequenceNo: TIntegerField;
    cds_LO1CreatedUser: TIntegerField;
    cds_LO1ModifiedUser: TIntegerField;
    cds_LO1DateCreated: TSQLTimeStampField;
    cds_LO1PartnerNo: TIntegerField;
    cds_LO1ProdInstructNo: TIntegerField;
    cds_LO1ShowInGrid: TIntegerField;
    cds_LO1PcsPerPkg: TIntegerField;
    cds_LO1CustomerNo: TIntegerField;
    cds_LO1CustomerPrice: TFloatField;
    cds_LO1CustomerShowInGrid: TIntegerField;
    cds_LO1LO_No: TIntegerField;
    cds_LO1Delivery_WeekNo: TIntegerField;
    cds_LO1DateModified: TSQLTimeStampField;
    cds_LO1VERK: TStringField;
    cds_LO1LASTSTALLE: TStringField;
    cds_LO1LEVERERA_TILL: TStringField;
    cds_LO1PKTKOD: TStringField;
    sq_LO1SupplierShipPlanObjectNo: TIntegerField;
    sq_LO1CustShipPlanDetailObjectNo: TIntegerField;
    sq_LO1ShipType: TIntegerField;
    sq_LO1ObjectType: TIntegerField;
    sq_LO1OrderNo: TIntegerField;
    sq_LO1OrderLineNo: TIntegerField;
    sq_LO1ShippingPlanNo: TIntegerField;
    sq_LO1SupplierNo: TIntegerField;
    sq_LO1LoadingLocationNo: TIntegerField;
    sq_LO1DeliveryTermsNo: TIntegerField;
    sq_LO1PaymentTermsNo: TIntegerField;
    sq_LO1Price: TFloatField;
    sq_LO1CurrencyNo: TIntegerField;
    sq_LO1NoOfUnits: TFloatField;
    sq_LO1PriceUnitNo: TIntegerField;
    sq_LO1VolumeUnitNo: TIntegerField;
    sq_LO1DestinationNo: TIntegerField;
    sq_LO1ShippingPlanStatus: TIntegerField;
    sq_LO1StartETDYearWeek: TIntegerField;
    sq_LO1EndETDYearWeek: TIntegerField;
    sq_LO1InternalNote: TStringField;
    sq_LO1ProductDescription: TStringField;
    sq_LO1LengthDescription: TStringField;
    sq_LO1AcceptedBySupplier: TIntegerField;
    sq_LO1ProductLengthNo: TIntegerField;
    sq_LO1ProductGroupNo: TIntegerField;
    sq_LO1ActualM3Net: TFloatField;
    sq_LO1ShipToInvPointNo: TIntegerField;
    sq_LO1ProductNo: TIntegerField;
    sq_LO1LOText: TMemoField;
    sq_LO1MinActualLengthMM: TFloatField;
    sq_LO1MaxActualLengthMM: TFloatField;
    sq_LO1PackageCode: TStringField;
    sq_LO1FreightOrderByClientNo: TIntegerField;
    sq_LO1SequenceNo: TIntegerField;
    sq_LO1CreatedUser: TIntegerField;
    sq_LO1ModifiedUser: TIntegerField;
    sq_LO1DateCreated: TSQLTimeStampField;
    sq_LO1PartnerNo: TIntegerField;
    sq_LO1ProdInstructNo: TIntegerField;
    sq_LO1ShowInGrid: TIntegerField;
    sq_LO1PcsPerPkg: TIntegerField;
    sq_LO1CustomerNo: TIntegerField;
    sq_LO1CustomerPrice: TFloatField;
    sq_LO1CustomerShowInGrid: TIntegerField;
    sq_LO1LO_No: TIntegerField;
    sq_LO1Delivery_WeekNo: TIntegerField;
    sq_LO1DateModified: TSQLTimeStampField;
    cds_LO1ALMM: TFloatField;
    ds_ProdInstruct: TDataSource;
    cds_LO1AT: TFloatField;
    cds_LO1AW: TFloatField;
    ds_Users: TDataSource;
    sq_LO1LEV: TFloatField;
    cds_LO1LEV: TFloatField;
    cds_LO1REST: TFloatField;
    sq_LO1LengthTyp: TStringField;
    cds_LO1LengthTyp: TStringField;
    sq_LO1LIPNo: TIntegerField;
    cds_LO1LIPNo: TIntegerField;
    ds_PhysInvByCityNo: TDataSource;
    ds_LIP: TDataSource;
    sq_LO1PkgCodePPNo: TIntegerField;
    cds_LO1PkgCodePPNo: TIntegerField;
    sq_LO1PriceListNo: TIntegerField;
    cds_LO1PriceListNo: TIntegerField;
    cds_LO1PrisLista: TStringField;
    sq_LO1InternKundFrakt: TFloatField;
    cds_LO1InternKundFrakt: TFloatField;
    sq_LO1Reference: TStringField;
    cds_LO1Reference: TStringField;
    ds_ELOLengths: TDataSource;
    ds_ELOLayout: TDataSource;
    sq_LO1PackageWidth: TIntegerField;
    sq_LO1PackageHeight: TIntegerField;
    cds_LO1PackageWidth: TIntegerField;
    cds_LO1PackageHeight: TIntegerField;
...
Begin
 ...
 Try
   cds_Pref.ParamByName('ClientNo').AsInteger:= cds_IntHdrCustomerNo.AsInteger ;
   cds_Pref.ParamByName('RoleType').AsInteger:= cInternal_Mill ;
   cds_Pref.Active:= True ;
   if cds_Pref.RecordCount > 0 then
   Begin
    cds_IntHdrDefaultShipToInvPointNo.AsInteger := cds_PrefLoadingLocationNo.AsInteger ;
    cds_IntHdrDefaultDeliveryTermsNo.AsInteger  :=  cds_PrefDefaultDeliveryTermsNo.AsInteger ;
    cds_IntHdrDefaultPaymentTermsNo.AsInteger   :=  cds_PrefDefaultPaymentTermsNo.AsInteger ;
    cds_IntHdrDefaultCurrencyNo.AsInteger       := cds_PrefDefaultCurrencyNo.AsInteger ;
    cds_IntHdrProductDisplayFormat.AsInteger    := cds_PrefDefaultVolumeUnitNo.AsInteger ;
    cds_IntHdrDefaultVolumeUnitNo.AsInteger     := cds_PrefDefaultVolumeUnitNo.AsInteger ;
    cds_IntHdrDefaultPriceUnitNo.AsInteger      := cds_PrefDefaultPriceUnitNo.AsInteger ;
...
procedure TdmcLO.cds_ProdInstruct1ReconcileError(
...
Begin
 cds_Pref.Active:= False ;
 Try
   cds_Pref.ParamByName('ClientNo').AsInteger:= cds_IntHdrSupplierNo.AsInteger ;
   cds_Pref.ParamByName('RoleType').AsInteger:= cInternal_Mill ;
   cds_Pref.Active:= True ;
   if cds_Pref.RecordCount > 0 then
   Begin
    cds_IntHdrDef_LoadingLocationNo.AsInteger:= cds_PrefLoadingLocationNo.AsInteger ;
   End ;
 Finally
  cds_Pref.Active:= False ;
 End ;
...
begin
 ...
 if (cds_IntHdrCustomerNo.IsNull = False) and (cds_IntHdrDefaultShipToInvPointNo.IsNull = False) then
 Begin
...
Begin
 ...
 Case cds_IntHdrProductDisplayFormat.AsInteger of
  cAKT_MM :  Result:=
       cds_ProdListActualThicknessMM.AsString
      +'X'+cds_ProdListActualWidthMM.AsString ;
  cNOM_MM :   Result:=
      cds_ProdListNominalThicknessMM.AsString
      +'X'+cds_ProdListNominalWidthMM.AsString ;
  cNOM_MM_och_AKT_MM :   Result:=
      cds_ProdListNominalThicknessMM.AsString
      +'X'+cds_ProdListNominalWidthMM.AsString
      +'('+cds_ProdListActualThicknessMM.AsString
      +'X'+cds_ProdListActualWidthMM.AsString+')' ;
  ...
  cTUM :  Result:=
      ...
      +'X'+cds_ProdListNominalWidthINCH.AsString ;
  cTUM_och_AKT_MM :   Result:=
      cds_ProdListNominalThicknessINCH.AsString
      +'X'+cds_ProdListNominalWidthINCH.AsString
      +'('+cds_ProdListActualThicknessMM.AsString
      +'X'+cds_ProdListActualWidthMM.AsString+')' ;
...
begin
 ...
 While Not cds_LO.eof do
  Begin
   if (cds_LOPrice.AsFloat < 1) AND (cds_LOPriceListNo.AsInteger < 1)
   and (cds_LOShippingPlanStatus.AsInteger <> STATUS_COMPLETE)
   and (cds_LOShippingPlanStatus.AsInteger <> STATUS_PRODUCTION_COMPLETE)
   and (cds_LOShippingPlanStatus.AsInteger <> STATUS_ANNULERAD)
   and (cds_LOShippingPlanStatus.AsInteger <> STATUS_ANNULERAD_BEKRAFTAD) then
   Begin
    Result:= True ;
   End ;
   cds_LO.Next ;
...
//  cds_LOLoadingLocationNo.AsInteger         := cds_IntHdrDef_LoadingLocationNo.AsInteger ;
  cds_LOShipToInvPointNo.AsInteger          := cds_IntHdrDefaultShipToInvPointNo.AsInteger ;
...
begin
  ...
  Try
    ...
    cds_LOSupplierShipPlanObjectNo.AsInteger    := dmsConnector.NextMaxNo('SupplierShippingPlan') ;
    cds_LOSupplierNo.AsInteger                  := cds_IntHdrSupplierNo.AsInteger ;
    cds_LOLoadingLocationNo.AsInteger           := cds_IntHdrDef_LoadingLocationNo.AsInteger ;
    ...
    cds_LOInternKundFrakt.AsFloat               := cds_IntHdrInternKundFrakt.AsFloat ;
    cds_LOPriceListNo.AsInteger                 := cds_IntHdrPriceListNo.AsInteger ;
    if (cds_LOPackageWidth.AsInteger > 0) and (cds_LOPackageHeight.AsInteger > 0) then
    cds_LOPcsPerPkg.AsInteger                   := cds_LOPackageWidth.AsInteger * cds_LOPackageHeight.AsInteger ;
//    cds_ELOLayout.Filter        := 'SupplierShipPlanObjectNo = ' + cds_LOSupplierShipPlanObjectNo.AsString ;
//    AddStandardPkgADDLOLayouts ;
//    SetILO_Records ;
  Finally
...
begin
 cds_ELOLengthsSupplierShipPlanObjectNo.AsInteger  := cds_LOSupplierShipPlanObjectNo.AsInteger ;
end;
