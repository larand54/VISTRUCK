...
//var FormBookingForm: TFormBookingFormorg;
...
Function TFormBookingFormOrg.DataSaved : Boolean ;
Begin
 Result:= True ;
 with dm_Booking do
 Begin
...
procedure TFormBookingFormOrg.CreateCo(const ShippingPlanNo: Integer);
begin
...
procedure TFormBookingFormOrg.FormCreate(Sender: TObject);
begin
 BookingNo:= -1 ;
...
procedure TFormBookingFormOrg.FormCloseQuery(Sender: TObject;
...
procedure TFormBookingFormOrg.FormShow(Sender: TObject);
begin
...
procedure TFormBookingFormOrg.acSaveExecute(Sender: TObject);
begin
 Save ;
end;

procedure TFormBookingFormOrg.Save ;
begin
 with dm_Booking do
 Begin
  CheckSaveVessel ;
...
procedure TFormBookingFormOrg.acCloseExecute(Sender: TObject);
begin
 Close ;
end;

procedure TFormBookingFormOrg.acSaveUpdate(Sender: TObject);
begin
...
procedure TFormBookingFormOrg.acChangeLayoutExecute(Sender: TObject);
begin
...
procedure TFormBookingFormOrg.acNewVesselNameExecute(Sender: TObject);
...
procedure TFormBookingFormOrg.LoadVessels ;
Begin
 With dmsSystem do
 Begin
...
procedure TFormBookingFormOrg.cbvesselExit(Sender: TObject);
begin
 CheckSaveVessel ;
end;

procedure TFormBookingFormOrg.CheckSaveVessel ;
...
procedure TFormBookingFormOrg.SetETDDate ;
Begin
 with dm_Booking do
 Begin
...
procedure TFormBookingFormOrg.acSetETDandSaveAndExitExecute(Sender: TObject);
begin
 SetETDDate ;
 Save ;
 ModalResult:= mrOK ;
...
procedure TFormBookingFormOrg.acSetETDExecute(Sender: TObject);
begin
 SetETDDate ;
end;
