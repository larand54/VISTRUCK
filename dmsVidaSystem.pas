...
uses
  ...
  cxGridTableView, Forms, uADStanIntf, uADStanOption, uADStanParam,
  uADStanError, uADDatSManager, uADPhysIntf, uADDAptIntf, uADStanAsync,
  uADDAptManager, uADCompClient, uADCompDataSet, SqlTimSt ;
...
type
 TAmbiguityEvent = procedure(
  ...
  TdmsSystem = class(TDataModule)
    ...
    cdsBarCodes: TADStoredProc;
    sp_Pkg_Res: TADStoredProc;
    sp_DelUserResPkgs: TADStoredProc;
    sp_CopyPOLoadToSales: TADStoredProc;
    sp_lencolpcspkgtypeno: TADStoredProc;
    sp_lencolm3pkgtypeno: TADStoredProc;
    cds_GridSettings: TADQuery;
    ...
    cdsGradeStamps: TADStoredProc;
    cdsPaperWraps: TADStoredProc;
    cdsPksByInvOwner_II: TADQuery;
    cds_pkgLog: TADStoredProc;
    ...
    cds_PkgsByInventering: TADQuery;
    ...
    cds_FtpParam: TADQuery;
    cds_PriceList: TADQuery;
    ...
    cdsRptNames: TADQuery;
    sq_DoLog: TADQuery;
    cds_PkgImpNoLO: TADQuery;
    ...
    sq_GetProductNoByProductCode: TADQuery;
    sq_GetProductNoByProductCodeProductNo: TIntegerField;
    sq_SetMallAsStd: TADQuery;
    ...
    sp_PopLengthSpecII: TADStoredProc;
    sp_DelLoad_Res: TADStoredProc;
    sp_Load_Res: TADStoredProc;
    cds_LoadWeigth: TADQuery;
    sq_GenerateLoadWeight: TADQuery;
