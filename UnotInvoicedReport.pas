...
uses
  ...
  dxEditor, dxExEdtr, ImgList, OleServer, Menus, dxTL, dxTLClms, dxDBTLCl, dxGrClms,
  dxDBCtrl, dxDBGrid, Buttons, OleCtrls, CRAXDDRT_TLB,
  ...
  cxLookAndFeels, cxLookAndFeelPainters, cxLabel ;
