object dmLoadEntrySSP: TdmLoadEntrySSP
  ...
  object cds_LoadHead: TADQuery
    ...
    Indexes = <
      item
        Active = True
        Selected = True
        Name = 'cds_LoadHeadLoadnoIndex'
        Fields = 'LoadNo'
      end>
    IndexName = 'cds_LoadHeadLoadnoIndex'
    ...
    object cds_LoadHeadShowOriginalLO: TIntegerField
      FieldName = 'ShowOriginalLO'
      Origin = 'ShowOriginalLO'
      ProviderFlags = [pfInUpdate]
  ...
  object cdsLORows: TADQuery
    ...
    SQL.Strings = (
      ...
      'SSP.ProductNo,'
        ...
        'SSP.ProductDescription                          AS INTERNPRODDES' +
        'C,'
      ''
      ...
      ''
        ...
        '  Left Outer join dbo.ProdInstru pin on pin.ProdInstruNo = OL.Pr' +
        'odInstructNo ON CSD.CustShipPlanDetailObjectNo = SSP.CustShipPla' +
        'nDetailObjectNo'
      ''
    ...
    object cdsLORowsCERTI: TStringField
      DisplayLabel = 'Certifierad'
      FieldName = 'CERTI'
      Origin = 'CERTI'
      ProviderFlags = []
      ReadOnly = True
    ...
    object cdsLORowsTräslag: TStringField
  ...
  object sq_OkToDeleteLSP: TADQuery
    CachedUpdates = True
    Connection = dmsConnector.ADConnection1
    FetchOptions.AssignedValues = [evCache]
    SQL.Strings = (
  ...
  object sp_creIntLO: TADStoredProc
    CachedUpdates = True
    Connection = dmsConnector.ADConnection1
    FetchOptions.AssignedValues = [evCache]
  ...
  object sp_UpdIntLO: TADStoredProc
    CachedUpdates = True
    Connection = dmsConnector.ADConnection1
    FetchOptions.AssignedValues = [evCache]
  ...
  object sp_RemPkgFromLoad_II: TADStoredProc
    CachedUpdates = True
    Connection = dmsConnector.ADConnection1
    FetchOptions.AssignedValues = [evCache]
  ...
  object sp_chgManLoadPkgs: TADStoredProc
    CachedUpdates = True
    Connection = dmsConnector.ADConnection1
    FetchOptions.AssignedValues = [evCache]
  ...
  object sp_LOBSetChanged: TADStoredProc
    Connection = dmsConnector.ADConnection1
  ...
  object cds_ObjecType: TADQuery
    CachedUpdates = True
    Connection = dmsConnector.ADConnection1
    FetchOptions.AssignedValues = [evCache]
    SQL.Strings = (
      'SELECT Max(SSP.ObjectType) as MaxObjectType'
      
        'FROM dbo.SupplierShippingPlan SSP WHERE SSP.ShippingPlanNo = :LO' +
        'No'
      '')
    Left = 200
    Top = 200
    ...
    object cds_ObjecTypeMaxObjectType: TIntegerField
      FieldName = 'MaxObjectType'
