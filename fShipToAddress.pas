...
uses
  ...
  StdCtrls, ExtCtrls, dxDBTLCl, dxGrClms, dxTL, dxDBCtrl, dxDBGrid, Menus,
...
type
  TfrmShipToAddress = class(TForm)
    ...
    procedure dbgridShipToAddressCompare(Sender: TObject; Node1,
...
//------------------------------------------------------------------------
procedure TfrmShipToAddress.dbgridShipToAddressCompare(Sender: TObject;
  Node1, Node2: TdxTreeListNode; var Compare: Integer);
begin
  //OpenDataSetEdit(VK_F1, tbCity);
end;
