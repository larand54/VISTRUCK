...
uses
  ...
  uADMoniFlatFile, uADGUIxFormsfAsync, uADCompGUIx ;
...
type
  TdmsConnector = class(TDataModule)
    ...
    spad_GetCurrPkgNo: TADStoredProc;
    spad_MaxNo_II: TADStoredProc;
    sp_GetSecondNo: TADStoredProc;
    sp_MaxNo: TADStoredProc;
    sp_GetCurrPkgNo: TADStoredProc;
    sp_MinNo: TADStoredProc;
    ADTransaction1: TADTransaction;
    sp_GetMaxLoadDetailNo: TADStoredProc;
