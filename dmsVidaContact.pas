...
uses
  ...
  VidaType, SqlTimSt, uADStanIntf, uADStanOption, uADStanParam,
  uADStanError, uADDatSManager, uADPhysIntf, uADDAptIntf, uADStanAsync,
  uADDAptManager, uADCompClient, uADCompDataSet, DB ;
...
type
  TdmsContact = class(TDataModule)
    ...
    sp_ClientCode: TADStoredProc;
    sq_GetLanguageID: TADQuery;
    sq_GetLanguageIDLanguageCode: TIntegerField;
    cds_PkgNoSerie: TADQuery;
    ...
    cds_LocalShipper: TADStoredProc;
    cds_LocalShipperClientNo: TIntegerField;
    cds_LocalShipperClientName: TStringField;
    cdsOwners: TADStoredProc;
    cdsProducers: TADStoredProc;
    ...
    sqGetEmailAdr: TADQuery;
    sqGetEmailAdrEmailAddress: TStringField;
    sqGetFirstAndLastName: TADQuery;
    ...
    ad_City: TADQuery;
    ad_CityCityNo: TIntegerField;
    ad_CityCityName: TStringField;
    ad_CitySequenceNo: TIntegerField;
    ad_CityDateCreated: TSQLTimeStampField;
    ad_CityModifiedUser: TSmallintField;
    ad_CityCreatedUser: TSmallintField;
    ad_CityImpVerk: TIntegerField;
    ds_City: TDataSource;
    ds_CompDelAdr: TDataSource;
    cds_Comp_DelAdr: TADQuery;
    ...
    sqAdrDepend: TADQuery;
    sqAdrDependaddressNo: TIntegerField;
    sqDelCompAdr: TADQuery;
    cds_CompAdr: TADQuery;
    ...
    sq_GetPIPNoOfCityNoByOwnerNo: TADQuery;
    sq_GetPIPNoOfCityNoByOwnerNoPIPNO: TIntegerField;
    sq_Get_PktNrLevKod: TADQuery;
...
function TdmsContact.GetPIPNoOfCityNoByOwnerNo (const OwnerNo, CityNo : Integer) : Integer ;
Begin
 sq_GetPIPNoOfCityNoByOwnerNo.ParamByName('OwnerNo').AsInteger  := OwnerNo ;
 sq_GetPIPNoOfCityNoByOwnerNo.ParamByName('CityNo').AsInteger   := CityNo ;
 sq_GetPIPNoOfCityNoByOwnerNo.Open ;
 Try
 if not sq_GetPIPNoOfCityNoByOwnerNo.Eof then
  Result  := sq_GetPIPNoOfCityNoByOwnerNoPIPNO.AsInteger
   else
    Result:= -1 ;
 Finally
