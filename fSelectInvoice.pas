...
type
  TfrmSelectInvoice = class(TForm)
    ...
    grdSelectInvoiceDBTableView1Inv_Value_After_Deduct_DIS_COMM: TcxGridDBColumn;
...
// Begin
  ...
  Begin
   cdsInvoiceList.SQL.Add('SELECT IH.InternalInvoiceNo AS INT_INVNO, IH.InvoiceDate AS INV_DATE, IH.AgentName AS AGENT, IL.Shipper AS SHIPPER,') ;
   cdsInvoiceList.SQL.Add('IH.CustomerName AS CUSTOMER, IL.ShippingPlanNo AS LO, INO.InvoiceNo AS INVOICE_NO,') ;

   cdsInvoiceList.SQL.Add('CASE') ;
   cdsInvoiceList.SQL.Add('WHEN IH.InvoiceType = 0 THEN '+'''NORMAL''') ;
   cdsInvoiceList.SQL.Add('WHEN IH.InvoiceType = 1 THEN '+'''PROFORMA, INVOICE LATER''') ;
   cdsInvoiceList.SQL.Add('WHEN IH.InvoiceType = 2 THEN '+'''PROFORMA''') ;
   ...
   cdsInvoiceList.SQL.Add('RTRIM(CONVERT(varchar(30), IH.InternalInvoiceNo))+') ;
   cdsInvoiceList.SQL.Add('RTRIM(CONVERT(varchar(30), IL.ShippingPlanNo)) AS Line_ID') ;
   cdsInvoiceList.SQL.Add(',IH.Inv_Value_After_Deduct_DIS_COMM, IH.CurrencyNo, IH.CustomerNo') ;


//   cdsInvoiceList.SQL.Add('IH.InternalInvoiceNo + IL.ShippingPlanNo AS Line_ID');


   cdsInvoiceList.SQL.Add('FROM dbo.InvoiceHeader IH, dbo.InvoiceLO IL, dbo.InvoiceNumber INo') ;
   cdsInvoiceList.SQL.Add('WHERE IL.InternalInvoiceNo = IH.InternalInvoiceNo') ;
   cdsInvoiceList.SQL.Add('AND IH.InvoiceType = 0') ;
   cdsInvoiceList.SQL.Add('AND IH.InvoiceDate > '+QuotedStr('2008-12-31')) ;
   ...
   Begin
    cdsInvoiceList.SQL.Add('AND IH.InternalInvoiceNo not in (Select Quick_InvoiceNo From dbo.Att_Ext_Services') ;
    cdsInvoiceList.SQL.Add('WHERE Quick_InvoiceNo =  IH.InternalInvoiceNo)') ;
   End ;

   cdsInvoiceList.SQL.Add('AND INo.InternalInvoiceNo = IH.InternalInvoiceNo ORDER BY InvoiceDate desc') ;
  End
  else
  Begin
   cdsInvoiceList.SQL.Add('SELECT IH.InternalInvoiceNo AS INT_INVNO, IH.InvoiceDate AS INV_DATE, IH.AgentName AS AGENT, IL.Shipper AS SHIPPER,') ;
   cdsInvoiceList.SQL.Add('IH.CustomerName AS CUSTOMER, IL.ShippingPlanNo AS LO, -1 AS INVOICE_NO,') ;
...
//   cdsInvoiceList.SQL.Add('IH.InternalInvoiceNo + IL.ShippingPlanNo AS Line_ID');
   ...
   cdsInvoiceList.SQL.Add('AND IL.InternalInvoiceNo = IH.InternalInvoiceNo AND IH.InternalInvoiceNo NOT IN') ;
   cdsInvoiceList.SQL.Add('(SELECT INO.InternalInvoiceNo FROM dbo.InvoiceNumber INo ) ORDER BY InvoiceDate desc') ;
  End ;
  End
  else
  ...
  Begin
   cdsInvoiceList.SQL.Add('SELECT IH.InternalInvoiceNo AS INT_INVNO, IH.InvoiceDate AS INV_DATE, IH.AgentName AS AGENT, IL.Shipper AS SHIPPER,') ;
   cdsInvoiceList.SQL.Add('IH.CustomerName AS CUSTOMER, IL.ShippingPlanNo AS LO, INO.ProformaInvoiceNo AS INVOICE_NO,') ;
...
//   cdsInvoiceList.SQL.Add('IH.InternalInvoiceNo + IL.ShippingPlanNo AS Line_ID');
   ...
   cdsInvoiceList.SQL.Add('FROM dbo.InvoiceHeader IH, dbo.InvoiceLO IL, dbo.ProformaInvoiceNumber INo') ;
   cdsInvoiceList.SQL.Add('WHERE IL.InternalInvoiceNo = IH.InternalInvoiceNo') ;
...
//   cdsInvoiceList.SQL.Add('IH.InternalInvoiceNo + IL.ShippingPlanNo AS Line_ID');
   ...
   cdsInvoiceList.SQL.Add('(SELECT INO.InternalInvoiceNo FROM dbo.ProformaInvoiceNumber INo ) ORDER BY InvoiceDate desc') ;
  End ;
  End
  else
...
//   cdsInvoiceList.SQL.Add('IH.InternalInvoiceNo + IL.ShippingPlanNo AS Line_ID');
  ...
  Begin
   cdsInvoiceList.SQL.Add('SELECT IH.InternalInvoiceNo AS INT_INVNO, IH.InvoiceDate AS INV_DATE, IH.AgentName AS AGENT, IL.Shipper AS SHIPPER,') ;
   cdsInvoiceList.SQL.Add('IH.CustomerName AS CUSTOMER, IL.ShippingPlanNo AS LO, INO.PO_InvoiceNo AS INVOICE_NO,') ;
...
//   cdsInvoiceList.SQL.Add('IH.InternalInvoiceNo + IL.ShippingPlanNo AS Line_ID');
   ...
   cdsInvoiceList.SQL.Add('FROM dbo.InvoiceHeader IH, dbo.InvoiceLO IL, dbo.InvoiceNumber_PO INo') ;
   cdsInvoiceList.SQL.Add('WHERE IL.InternalInvoiceNo = IH.InternalInvoiceNo') ;
...
//   cdsInvoiceList.SQL.Add('IH.InternalInvoiceNo + IL.ShippingPlanNo AS Line_ID');
   ...
   cdsInvoiceList.SQL.Add('(SELECT INO.InternalInvoiceNo FROM dbo.InvoiceNumber_PO INo ) ORDER BY InvoiceDate desc') ;
  End ;
  End
...
//   cdsInvoiceList.SQL.Add('IH.InternalInvoiceNo + IL.ShippingPlanNo AS Line_ID');
   ...
   cdsInvoiceList.SQL.Add('FROM dbo.InvoiceHeader IH, dbo.InvoiceLO IL, dbo.InvoiceNo_USA INo') ;
   cdsInvoiceList.SQL.Add('WHERE IL.InternalInvoiceNo = IH.InternalInvoiceNo') ;
...
//   cdsInvoiceList.SQL.Add('IH.InternalInvoiceNo + IL.ShippingPlanNo AS Line_ID');
   ...
   cdsInvoiceList.SQL.Add('(SELECT INO.InternalInvoiceNo FROM dbo.InvoiceNo_USA INo ) ORDER BY InvoiceDate desc') ;
  End ;
  End ;
