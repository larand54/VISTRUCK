object dmcLO: TdmcLO
  ...
  object sq_LO1: TSQLQuery
    ...
    Left = 208
    Top = 16
    object sq_LO1SupplierShipPlanObjectNo: TIntegerField
      FieldName = 'SupplierShipPlanObjectNo'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object sq_LO1CustShipPlanDetailObjectNo: TIntegerField
      FieldName = 'CustShipPlanDetailObjectNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ShipType: TIntegerField
      FieldName = 'ShipType'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ObjectType: TIntegerField
      FieldName = 'ObjectType'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1OrderNo: TIntegerField
      FieldName = 'OrderNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1OrderLineNo: TIntegerField
      FieldName = 'OrderLineNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ShippingPlanNo: TIntegerField
      FieldName = 'ShippingPlanNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1SupplierNo: TIntegerField
      FieldName = 'SupplierNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1LoadingLocationNo: TIntegerField
      FieldName = 'LoadingLocationNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1DeliveryTermsNo: TIntegerField
      FieldName = 'DeliveryTermsNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1PaymentTermsNo: TIntegerField
      FieldName = 'PaymentTermsNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1Price: TFloatField
      FieldName = 'Price'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1CurrencyNo: TIntegerField
      FieldName = 'CurrencyNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1NoOfUnits: TFloatField
      FieldName = 'NoOfUnits'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1PriceUnitNo: TIntegerField
      FieldName = 'PriceUnitNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1VolumeUnitNo: TIntegerField
      FieldName = 'VolumeUnitNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1DestinationNo: TIntegerField
      FieldName = 'DestinationNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ShippingPlanStatus: TIntegerField
      FieldName = 'ShippingPlanStatus'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1StartETDYearWeek: TIntegerField
      FieldName = 'StartETDYearWeek'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1EndETDYearWeek: TIntegerField
      FieldName = 'EndETDYearWeek'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1InternalNote: TStringField
      FieldName = 'InternalNote'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ProductDescription: TStringField
      FieldName = 'ProductDescription'
      ProviderFlags = [pfInUpdate]
      Size = 100
    end
    object sq_LO1LengthDescription: TStringField
      FieldName = 'LengthDescription'
      ProviderFlags = [pfInUpdate]
      Size = 100
    end
    object sq_LO1AcceptedBySupplier: TIntegerField
      FieldName = 'AcceptedBySupplier'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ProductLengthNo: TIntegerField
      FieldName = 'ProductLengthNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ProductGroupNo: TIntegerField
      FieldName = 'ProductGroupNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ActualM3Net: TFloatField
      FieldName = 'ActualM3Net'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ShipToInvPointNo: TIntegerField
      FieldName = 'ShipToInvPointNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ProductNo: TIntegerField
      FieldName = 'ProductNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1LOText: TMemoField
      FieldName = 'LOText'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
    end
    object sq_LO1MinActualLengthMM: TFloatField
      FieldName = 'MinActualLengthMM'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1MaxActualLengthMM: TFloatField
      FieldName = 'MaxActualLengthMM'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1PackageCode: TStringField
      FieldName = 'PackageCode'
      ProviderFlags = [pfInUpdate]
      Size = 10
    end
    object sq_LO1FreightOrderByClientNo: TIntegerField
      FieldName = 'FreightOrderByClientNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1SequenceNo: TIntegerField
      FieldName = 'SequenceNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1CreatedUser: TIntegerField
      FieldName = 'CreatedUser'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ModifiedUser: TIntegerField
      FieldName = 'ModifiedUser'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1DateCreated: TSQLTimeStampField
      FieldName = 'DateCreated'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1PartnerNo: TIntegerField
      FieldName = 'PartnerNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ProdInstructNo: TIntegerField
      FieldName = 'ProdInstructNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1ShowInGrid: TIntegerField
      FieldName = 'ShowInGrid'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1PcsPerPkg: TIntegerField
      FieldName = 'PcsPerPkg'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1CustomerNo: TIntegerField
      FieldName = 'CustomerNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1CustomerPrice: TFloatField
      FieldName = 'CustomerPrice'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1CustomerShowInGrid: TIntegerField
      FieldName = 'CustomerShowInGrid'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1LO_No: TIntegerField
      FieldName = 'LO_No'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1Delivery_WeekNo: TIntegerField
      FieldName = 'Delivery_WeekNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1DateModified: TSQLTimeStampField
      FieldName = 'DateModified'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1LengthTyp: TStringField
      FieldName = 'LengthTyp'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1LEV: TFloatField
      FieldName = 'LEV'
      ProviderFlags = []
    end
    object sq_LO1LIPNo: TIntegerField
      FieldName = 'LIPNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1PkgCodePPNo: TIntegerField
      FieldName = 'PkgCodePPNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1PriceListNo: TIntegerField
      FieldName = 'PriceListNo'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1InternKundFrakt: TFloatField
      FieldName = 'InternKundFrakt'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1Reference: TStringField
      FieldName = 'Reference'
      ProviderFlags = [pfInUpdate]
      Size = 50
    end
    object sq_LO1PackageWidth: TIntegerField
      FieldName = 'PackageWidth'
      ProviderFlags = [pfInUpdate]
    end
    object sq_LO1PackageHeight: TIntegerField
      FieldName = 'PackageHeight'
      ProviderFlags = [pfInUpdate]
    end
  end
  object dsp_LO1: TDataSetProvider
    DataSet = sq_LO1
    UpdateMode = upWhereKeyOnly
    OnGetTableName = dsp_LO1GetTableName
    Left = 208
    Top = 64
  end
  object cds_LO1: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dsp_LO'
    BeforePost = cds_LO1BeforePost
    Left = 208
    Top = 112
    object cds_LO1PackageCode: TStringField
      DisplayLabel = 'PKTKOD'
      FieldName = 'PackageCode'
      ProviderFlags = [pfInUpdate]
      Size = 10
    end
    object cds_LO1VERK: TStringField
      FieldKind = fkLookup
      FieldName = 'VERK'
    ...
    object cds_LO1ShippingPlanStatus: TIntegerField
      DisplayLabel = 'STATUS'
      FieldName = 'ShippingPlanStatus'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ProductDescription: TStringField
      DisplayLabel = 'PRODUKTBESKRIVNING'
      FieldName = 'ProductDescription'
      ProviderFlags = [pfInUpdate]
      Size = 100
    end
    object cds_LO1LengthDescription: TStringField
      DisplayLabel = 'L'#196'NGDBESKRIVNING'
      FieldName = 'LengthDescription'
      ProviderFlags = [pfInUpdate]
      Size = 100
    end
    object cds_LO1LASTSTALLE: TStringField
    ...
    object cds_LO1LEVERERA_TILL: TStringField
      DisplayLabel = 'LEV.TILL'
      FieldKind = fkLookup
      FieldName = 'LEVERERA_TILL'
      LookupKeyFields = 'PhyInvPointNameNo'
      LookupResultField = 'CITYNAME'
    ...
    object cds_LO1NoOfUnits: TFloatField
      DisplayLabel = 'ANTAL'
      FieldName = 'NoOfUnits'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = '#,###,###.000'
    end
    object cds_LO1StartETDYearWeek: TIntegerField
      DisplayLabel = 'START'
      FieldName = 'StartETDYearWeek'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1EndETDYearWeek: TIntegerField
      DisplayLabel = 'SLUT'
      FieldName = 'EndETDYearWeek'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1Price: TFloatField
      DisplayLabel = 'PRIS'
      FieldName = 'Price'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1CustomerPrice: TFloatField
      FieldName = 'CustomerPrice'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1SupplierShipPlanObjectNo: TIntegerField
      DisplayLabel = 'LO ID'
      FieldName = 'SupplierShipPlanObjectNo'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object cds_LO1CustShipPlanDetailObjectNo: TIntegerField
      FieldName = 'CustShipPlanDetailObjectNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ShipType: TIntegerField
      FieldName = 'ShipType'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ObjectType: TIntegerField
      FieldName = 'ObjectType'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1OrderNo: TIntegerField
      FieldName = 'OrderNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1VolumeUnitNo: TIntegerField
      FieldName = 'VolumeUnitNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1OrderLineNo: TIntegerField
      FieldName = 'OrderLineNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ShippingPlanNo: TIntegerField
      FieldName = 'ShippingPlanNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1SupplierNo: TIntegerField
      FieldName = 'SupplierNo'
      ProviderFlags = [pfInUpdate]
      OnChange = cds_LO1SupplierNoChange
    end
    object cds_LO1LoadingLocationNo: TIntegerField
      FieldName = 'LoadingLocationNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1DeliveryTermsNo: TIntegerField
      FieldName = 'DeliveryTermsNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1PaymentTermsNo: TIntegerField
      FieldName = 'PaymentTermsNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1CurrencyNo: TIntegerField
      FieldName = 'CurrencyNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1PriceUnitNo: TIntegerField
      FieldName = 'PriceUnitNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1DestinationNo: TIntegerField
      FieldName = 'DestinationNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1InternalNote: TStringField
      FieldName = 'InternalNote'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1AcceptedBySupplier: TIntegerField
      FieldName = 'AcceptedBySupplier'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ProductLengthNo: TIntegerField
      FieldName = 'ProductLengthNo'
      ProviderFlags = [pfInUpdate]
      OnChange = cds_LO1ProductLengthNoChange
    end
    object cds_LO1ProductGroupNo: TIntegerField
      FieldName = 'ProductGroupNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ActualM3Net: TFloatField
      FieldName = 'ActualM3Net'
      ProviderFlags = [pfInUpdate]
      DisplayFormat = '###,###.000'
    end
    object cds_LO1ShipToInvPointNo: TIntegerField
      FieldName = 'ShipToInvPointNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ProductNo: TIntegerField
      FieldName = 'ProductNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1LOText: TMemoField
      FieldName = 'LOText'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
    end
    object cds_LO1MinActualLengthMM: TFloatField
      FieldName = 'MinActualLengthMM'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1MaxActualLengthMM: TFloatField
      FieldName = 'MaxActualLengthMM'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1FreightOrderByClientNo: TIntegerField
      FieldName = 'FreightOrderByClientNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1SequenceNo: TIntegerField
      FieldName = 'SequenceNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1CreatedUser: TIntegerField
      FieldName = 'CreatedUser'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ModifiedUser: TIntegerField
      FieldName = 'ModifiedUser'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1DateCreated: TSQLTimeStampField
      FieldName = 'DateCreated'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1PartnerNo: TIntegerField
      FieldName = 'PartnerNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ProdInstructNo: TIntegerField
      FieldName = 'ProdInstructNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1ShowInGrid: TIntegerField
      FieldName = 'ShowInGrid'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1PcsPerPkg: TIntegerField
      FieldName = 'PcsPerPkg'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1CustomerNo: TIntegerField
      FieldName = 'CustomerNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1CustomerShowInGrid: TIntegerField
      FieldName = 'CustomerShowInGrid'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1LO_No: TIntegerField
      FieldName = 'LO_No'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1Delivery_WeekNo: TIntegerField
      FieldName = 'Delivery_WeekNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1DateModified: TSQLTimeStampField
      FieldName = 'DateModified'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1LengthTyp: TStringField
      DisplayLabel = 'INT.L'#196'NGD'
      FieldName = 'LengthTyp'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1PKTKOD: TStringField
      FieldKind = fkLookup
      FieldName = 'PKTKOD'
      LookupKeyFields = 'PackageTypeNo'
      LookupResultField = 'PackageCodeNo'
      KeyFields = 'SequenceNo'
      LookupCache = True
      Lookup = True
    end
    object cds_LO1ALMM: TFloatField
      FieldKind = fkLookup
      FieldName = 'ALMM'
      LookupKeyFields = 'LNO'
      LookupResultField = 'AMM'
      KeyFields = 'ProductLengthNo'
      LookupCache = True
      Lookup = True
    end
    object cds_LO1AT: TFloatField
      FieldKind = fkLookup
      FieldName = 'AT'
      LookupKeyFields = 'ProductGroupNo'
      LookupResultField = 'ActualThicknessMM'
      KeyFields = 'ProductGroupNo'
      LookupCache = True
      Lookup = True
    end
    object cds_LO1AW: TFloatField
      FieldKind = fkLookup
      FieldName = 'AW'
      LookupKeyFields = 'ProductGroupNo'
      LookupResultField = 'ActualWidthMM'
      KeyFields = 'ProductGroupNo'
      LookupCache = True
      Lookup = True
    end
    object cds_LO1LEV: TFloatField
      FieldName = 'LEV'
      ProviderFlags = []
      DisplayFormat = '#,###,###.000'
    end
    object cds_LO1REST: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'REST'
      DisplayFormat = '#,###,###.000'
    end
    object cds_LO1LIPNo: TIntegerField
      FieldName = 'LIPNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1PkgCodePPNo: TIntegerField
      DisplayLabel = 'Variantnr'
      FieldName = 'PkgCodePPNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1PriceListNo: TIntegerField
      FieldName = 'PriceListNo'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1PrisLista: TStringField
      FieldKind = fkLookup
      FieldName = 'PrisLista'
    ...
    object cds_LO1InternKundFrakt: TFloatField
      DisplayLabel = 'Frakt'
      FieldName = 'InternKundFrakt'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1Reference: TStringField
      FieldName = 'Reference'
      ProviderFlags = [pfInUpdate]
      Size = 50
    end
    object cds_LO1PackageWidth: TIntegerField
      DisplayLabel = 'Pktbredd'
      FieldName = 'PackageWidth'
      ProviderFlags = [pfInUpdate]
    end
    object cds_LO1PackageHeight: TIntegerField
      DisplayLabel = 'Pkth'#246'jd'
      FieldName = 'PackageHeight'
      ProviderFlags = [pfInUpdate]
    end
  end
  ...
  object sqPkgLayoutStd: TFDQuery
    CachedUpdates = True
    Connection = dmsConnector.FDConnection1
    FetchOptions.AssignedValues = [evCache]
    SQL.Strings = (
