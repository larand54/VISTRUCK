...
type
  TdmsSortOrder = class(TDataModule)
    ...
    cds_SortOrderPlannedProductionTime: TFMTBCDField;
    cds_SortOrderPercentTrimloss: TFMTBCDField;
    cds_SortOrderProgramNo: TIntegerField;
    cds_SortOrderRealStartTime: TSQLTimeStampField;
    cds_SortOrderRealEndTime: TSQLTimeStampField;
    cds_SortOrderRealProductionTime: TFMTBCDField;
    cds_SortOrderWeekNo: TStringField;
    cds_SortOrderYearNo: TIntegerField;
    cds_SortOrderYearWeek: TStringField;
    cds_SortOrderChipsM3Solid: TFMTBCDField;
    cds_SortOrderChipsValue: TFMTBCDField;
    cds_SortOrderRawMtrlCost: TFMTBCDField;
    cds_SortOrderRawMtrlAM3: TFMTBCDField;
    cds_SortOrderProductionCost: TFMTBCDField;
    cds_SortOrderProductionAM3: TFMTBCDField;
    cds_SortOrderCostPerAM3: TFMTBCDField;
    cds_SortOrderSawdustM3Solid: TFMTBCDField;
    cds_SortOrderSawdustValue: TFMTBCDField;
    cds_SortOrderNoOfWorkers: TFMTBCDField;
    cds_SortOrderPostningstid: TFMTBCDField;
    cds_SortOrderNoOfWorkersPostning: TFMTBCDField;
    cds_SortOrderAvkapAM3: TFMTBCDField;
    cds_SortOrderAvkapLPM: TFMTBCDField;
    cds_SortOrderKassationAM3: TFMTBCDField;
    cds_SortOrderKassationLPM: TFMTBCDField;
    cds_SortOrderAvkapValue: TFMTBCDField;
    cds_SortOrderKassationValue: TFMTBCDField;
    cds_SortOrderTotalSalaryCost: TFMTBCDField;
    cds_SortOrderFeedSpeed: TFMTBCDField;
    cds_SortOrderRawMtrlAM1: TFMTBCDField;
    cds_SortOrderProductionAM1: TFMTBCDField;
    cds_SortOrderProductionValue: TFMTBCDField;
    cds_SortOrderTotalValue: TFMTBCDField;
    cds_SortOrderTotalAM3: TFMTBCDField;
    cds_SortOrderTotalAM1: TFMTBCDField;
    cds_SortOrderTotalCost: TFMTBCDField;
    cds_SortOrderResultAO: TFMTBCDField;
    cds_SortOrderCostPerAM1: TFMTBCDField;
    cds_SortOrderAvgRawMtrlPriceAM3: TFMTBCDField;
    cds_SortOrderAvgProductPriceAM3: TFMTBCDField;
    cds_SortOrderAvgProductPriceAM1: TFMTBCDField;
    cds_SortOrderAvgRawMtrlPriceAM1: TFMTBCDField;
    cds_SortOrderEfficiencyFactor: TFMTBCDField;
    cds_SortOrderLegoCostPerAM3: TFMTBCDField;
    cds_SortOrderRealLpmMinute: TFMTBCDField;
    cds_SortOrderAvgProductPriceNM3: TFMTBCDField;
    cds_SortOrderAvgRawMtrlPriceNM3: TFMTBCDField;
    cds_SortOrderProductionNM3: TFMTBCDField;
    cds_SortOrderRawMtrlNM3: TFMTBCDField;
    cds_SortOrderSalaryCostPerHour: TFMTBCDField;
    cds_SortOrderEfficiencyFactorWOStopptime: TFMTBCDField;
    cds_SortOrderCostPerNM3: TFMTBCDField;
    cds_SortOrderPreCalcEfficiencyFactor: TFMTBCDField;
    cds_SortOrderRawMtrlNM3NoOmSort: TFMTBCDField;
    cds_SorOrdRowPlannedAM3: TFMTBCDField;
    cds_SorOrdRowNoOfUnits: TFMTBCDField;
    cds_SorOrdRowCostDist: TFMTBCDField;
    cds_SorOrdRowPrice: TFMTBCDField;
    cds_SorOrdRowAM3: TFMTBCDField;
    cds_SorOrdRowNM3: TFMTBCDField;
    cds_SorOrdRowAM1: TFMTBCDField;
    cds_SorOrdRowOutturnOfInputAM3: TFMTBCDField;
    cds_SorOrdRowProductValue: TFMTBCDField;
    cds_SorOrdRowPlannedNM3: TFMTBCDField;
    cds_SorOrdRowPrintGroupNo: TIntegerField;
    cds_SorOrdRowInfo1: TStringField;
    cds_SorOrdRowInfo2: TStringField;
    cds_SorOrdRowOriginalReferens: TStringField;
    cds_SorOrdRowGoodsMarks: TStringField;
    cds_SorOrdRowColorCode: TStringField;
    cds_SorOrdRowNT_U: TFloatField;
    cds_SorOrdRowNW_U: TFloatField;
    cds_SorOrdRowHeadLO: TIntegerField;
    cds_SorOrdRowLocalLO: TIntegerField;
    cds_SorOrdRowNoInventory: TIntegerField;
    cds_SorOrdRowMallsorno: TIntegerField;
    cds_SorOrdRowSubProduct: TIntegerField;
    cds_SorOrdRowGruppSpec: TIntegerField;
    cds_SorOrdRowGradeNamePrintOption: TIntegerField;
    cds_SorOrdRowPkgArticleNo: TIntegerField;
    cds_ProductionUnitLegoCostPerAM3: TFMTBCDField;
    cds_SchedulerPostningstid: TFMTBCDField;
    cds_SchedulerPreCalcEfficiencyFactor: TFMTBCDField;
    cds_SchedulerFeedSpeed: TFMTBCDField;
    cds_SchedulerPlannedProductionTime: TFMTBCDField;
    cds_SchedulerPlannedWorkingTime: TFMTBCDField;
    FD_NewProductionPris: TFMTBCDField;
    ...
    cds_SORawBookedNM3: TFMTBCDField;
    cds_SORawPIPNo: TIntegerField;
    cds_SORawDateCreated: TSQLTimeStampField;
    cds_SORawCreatedUser: TIntegerField;
    cds_SORawUtfall2: TFMTBCDField;
    cds_SORawBookedAM3: TFMTBCDField;
    cds_SORawStatus: TIntegerField;
    cds_SORawUsedAM3: TFMTBCDField;
    cds_SORawPlannedOutputAM3: TFMTBCDField;
    ...
    cds_SORawKassationAM3: TFMTBCDField;
    cds_SORawKassationAM1: TFMTBCDField;
    cds_SORawAvgLength: TFMTBCDField;
    cds_SORawPlannedAM1: TFMTBCDField;
    ...
    cds_SORawPlannedOutputNM3: TFMTBCDField;
    cds_SORawUsedNM3: TFMTBCDField;
    cds_SORawOrderNo: TIntegerField;
    cds_SORawNoOfUnits: TFMTBCDField;
    cds_SORawVolumeUnitNo: TIntegerField;
    cds_SORawRowNo: TIntegerField;
    cds_SORawRegPointNo: TIntegerField;
    cds_SORawFeedSpeed: TFMTBCDField;
    cds_SORawPeriod: TStringField;
    ...
    FD_ProdTimeSegProductionTime: TFMTBCDField;
