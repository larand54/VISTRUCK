object XMLImportExport: TXMLImportExport
  ...
  object PageControl1: TPageControl
    ...
    object tsExport: TTabSheet
      ...
      object BitBtn3: TBitBtn
        ...
        Width = 249
        Height = 25
        Action = acExportTally
        Caption = 'acExportTally'
        TabOrder = 6
      end
    end
  end
  ...
  object ADOConnection1: TADOConnection
    ConnectionString = 
      ...
      'e;User ID=Lars;Initial Catalog=vis_vida;Data Source=vistestsql.v' +
      'ida.se;Use Procedure for Prepare=1;Auto Translate=True;Packet Si' +
      'ze=4096;Workstation ID=CARMAK-FASTER;Use Encryption for Data=Fal' +
  ...
  object ActionList1: TActionList
    ...
    object acExportTally: TAction
      Caption = 'acExportTally'
      OnExecute = acExportTallyExecute
    end
  end
