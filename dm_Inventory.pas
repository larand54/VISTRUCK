...
type
  TdmInventory = class(TDataModule)
    ...
    cds_EXCELView: TFDQuery;
    ds_EXCELView: TDataSource;
    sq_NB: TFDQuery;
    sq_NT: TFDQuery;
    ...
    cds_EXCELViewLogicalInventoryName: TStringField;
    cds_EXCELViewpcs: TIntegerField;
    cds_EXCELViewAM3: TFloatField;
    cds_EXCELViewNM3: TFloatField;
    cds_EXCELViewdim: TStringField;
    cds_EXCELViewTS: TStringField;
    cds_EXCELViewPC: TStringField;
    cds_EXCELViewKV: TStringField;
    cds_EXCELViewUT: TStringField;
    cds_EXCELViewLIPNo: TIntegerField;
    cds_EXCELViewPIPNo: TIntegerField;
    cds_EXCELViewVarugruppNamn: TStringField;
    cds_EXCELViewREFERENCE: TStringField;
    cds_EXCELViewInfo1: TStringField;
    cds_EXCELViewInfo2: TStringField;
    cds_EXCELViewAreaName: TStringField;
    cds_EXCELViewPositionName: TStringField;
    cds_EXCELViewCity: TStringField;
    cds_EXCELViewPaket: TIntegerField;
