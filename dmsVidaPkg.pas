...
Function TdmsPkg.GetLengthsEntered : String ;
    ...
    Begin
     mtPcsPerLength.Insert ;
     mtPcsPerLengthProductLengthNo.AsInteger  := dmsSystem.GetProductLengthNoByALMM
     (FloatToStr(mtpackages.Fields[cTOTALLPM].AsFloat / mtPackages.Fields[cTOTALPCS].AsInteger * 1000)) ;
