...
uses
  ...
  DB, FireDAC.Comp.DataSet, FireDAC.Comp.Client, dxBar, cxClasses, StdCtrls,
  ...
  dxSkinXmas2008Blue, dxSkinsdxBarPainter, siComp, siLngLnk, System.Actions;
...
begin
  ...
  if IsModified then begin
    ...
    wRet := MessageDlg(siLangLinked_frmDBForm.GetTextOrDefault('IDS_0' (* 'Spara ändringar?' *) ), mtConfirmation, [mbYes, mbNo, mbCancel], 0);
