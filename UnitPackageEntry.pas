...
//    procedure AddPkgsToSSPLoadFromPkgEntryTemp(Sender: TObject);
//    procedure AddPkgsToCSDLoadFromPkgEntryTEMP(Sender: TObject);
...
//    procedure RemoveAndADD_Matches(Sender : TObject);
    ...
    procedure LaggUppPaketMedPaketNr(Sender: TObject;Var NoOfErrorPkgnr : Integer; const AntalPaketAttLaggaUpp : Integer) ;
...
uses dmsVidaProduct, VidaConst,   VidaUser, dmsDataConn,
  ...
  uAddSpecialLengths, dmc_UserProps ;
  //, dmcLoadEntryCSD, dmcLoadEntryCSDTemp, dmcLoadEntrySSPTemp;
...
Begin
 Result:= False ;
 With dmsProduct do
 Begin For x := FirstLengthColumnInmatningViaLast to mtPackages.FieldCount - 1 do
  Begin
    ...
    ADD_LO_Lengths
      ...
      if bcLengthOption.ItemIndex = 1 then
       MakeLengthQueryAllaPGLength //All lengths
         ...
         if bcLengthOption.ItemIndex = 2 then
         Begin
...
MakeLengthQuery_STD_Lengths (mtUserPropLengthGroupNo.AsInteger)
         ...
         End
          ...
          if bcLengthOption.ItemIndex = 3 then
           Begin
            MakeLengthQuery_II ;
           End
            else
  ...
  Begin
   ...
   mtPackages.FieldByName(sq_ProductLengthsActualLengthMM.AsString).Visible:= True ;
 ...
 if dmsProduct.InputOption = INPUT_LOPM_TOTAL_LOPM then
  ...
  if dmsProduct.InputOption = INPUT_LOPM_AVERAGE_LENGTH then
  Begin
  ...
  if dmsProduct.InputOption = INPUT_ARTICLES then
  Begin
   mtPackages.FieldDefs.Add('1',ftFloat,0,False) ;
   mtPackages.FieldDefs[x].CreateField(nil);
...
//Set length column props
  For x := FirstLengthColumnInmatningViaLast to grdPackagesDBBandedTableView1.ColumnCount - 1 do
  Begin
//   grdPackagesDBBandedTableView1.Columns[x].PropertiesClass:=  TcxTextEditProperties;
   Properties := grdPackagesDBBandedTableView1.Columns[x].Properties AS TcxTextEditProperties;
...
//   grdPackagesDBBandedTableView1.Columns[cPACKAGENO].Width:= 65 ;
   ...
   grdPackagesDBBandedTableView1.Columns[CDESCRIPTION].Position.BandIndex   := 0 ;
   ...
   grdPackagesDBBandedTableView1.Columns[cTOTALM2].Position.BandIndex       := 1 ;
    ...
    grdPackagesDBBandedTableView1.Columns[cRECID].Width         := mtUserProp.Fields.Fields[40].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[CDESCRIPTION].Width   := mtUserProp.Fields.Fields[41].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cSUPPLIERCODE].Width  := mtUserProp.Fields.Fields[42].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cTotalPcs].Width      := mtUserProp.Fields.Fields[43].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cTOTALACTM3].Width    := mtUserProp.Fields.Fields[44].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cTOTALLPM].Width      := mtUserProp.Fields.Fields[45].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cTOTALM2].Width       := mtUserProp.Fields.Fields[46].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cPACKAGENO].Width     := mtUserProp.Fields.Fields[49].AsInteger ;


    grdPackagesDBBandedTableView1.Columns[CDESCRIPTION].Position.ColIndex   := mtUserProp.Fields.Fields[50].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cSUPPLIERCODE].Position.ColIndex  := mtUserProp.Fields.Fields[51].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cPACKAGENO].Position.ColIndex     := mtUserProp.Fields.Fields[52].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cTotalPcs].Position.ColIndex      := mtUserProp.Fields.Fields[53].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cTOTALACTM3].Position.ColIndex    := mtUserProp.Fields.Fields[54].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cTOTALLPM].Position.ColIndex      := mtUserProp.Fields.Fields[30].AsInteger ;
    grdPackagesDBBandedTableView1.Columns[cTOTALM2].Position.ColIndex       := mtUserProp.Fields.Fields[31].AsInteger ;
...
//  grdPackagesDBBandedTableView1.OptionsView.ColumnAutoWidth:= mtUserPropNewItemRow.AsInteger = 1 ;
  ...
  grdPackagesDBBandedTableView1.Bands[0].Width:= mtUserProp.Fields.Fields[47].AsInteger ;
  grdPackagesDBBandedTableView1.Bands[1].Width:= mtUserProp.Fields.Fields[48].AsInteger ;
...
Var x : Integer ;
begin
// LoadGridLayout(const UserID : Integer;const ViewName : String;AGridView: TcxGridTableView) : Boolean ;
// if dmsSystem.LoadGridLayout(ThisUser.UserID, Self.Name+'/'+grdPackagesDBBandedTableView1.Name, grdPackagesDBBandedTableView1) then ;
 ...
 Begin
  Try
//  eSupplierCode.Text                := SupplierCode ;
...
//  mtProdSpecificLengths.Active      := True ;
  ...
  mtUserPropSupplierCode.AsString   := SupplierCode ;
   ...
   Begin
    ...
    End
     ...
     Begin
      mtUserPropVerkNo.AsInteger  := ThisUser.CompanyNo ;
     End ;
   End
   else
   Begin
  ...
  if dmsContact.IsClientLego(ThisUser.CompanyNo) = 6 then
   mtUserPropRegPointNo.AsInteger  := mp_Lego
    else
...
begin
 ...
 Begin
  ...
  End ;
  Get_LO_LinesMatched ;//(mtpackages.Fields[cRECID].AsInteger,  Trim(mtpackages.Fields[cSUPPLIERCODE].AsString)) ;
...
begin
 ...
 Begin
  ...
  mtLO_Records.Filter:= 'SupplierShipPlanObjectNo = '+mtLO_RecordsSupplierShipPlanObjectNo.AsString ;
...
begin
 ...
 Begin
  ...
  mtUserProp.Edit ;
  mtUserProp.Fields.Fields[40].AsInteger  := grdPackagesDBBandedTableView1.Columns[cRECID].Width ;
  mtUserProp.Fields.Fields[41].AsInteger  := grdPackagesDBBandedTableView1.Columns[CDESCRIPTION].Width ;
  mtUserProp.Fields.Fields[42].AsInteger  := grdPackagesDBBandedTableView1.Columns[cSUPPLIERCODE].Width ;
  mtUserProp.Fields.Fields[43].AsInteger  := grdPackagesDBBandedTableView1.Columns[cTotalPcs].Width ;
  mtUserProp.Fields.Fields[44].AsInteger  := grdPackagesDBBandedTableView1.Columns[cTOTALACTM3].Width ;
  mtUserProp.Fields.Fields[45].AsInteger  := grdPackagesDBBandedTableView1.Columns[cTOTALLPM].Width ;
  mtUserProp.Fields.Fields[46].AsInteger  := grdPackagesDBBandedTableView1.Columns[cTOTALM2].Width ;
  mtUserProp.Fields.Fields[47].AsInteger  := grdPackagesDBBandedTableView1.Bands[0].Width ;
  mtUserProp.Fields.Fields[48].AsInteger  := grdPackagesDBBandedTableView1.Bands[1].Width ;
  mtUserProp.Fields.Fields[49].AsInteger  := grdPackagesDBBandedTableView1.Columns[cPACKAGENO].Width ;

  mtUserProp.Fields.Fields[50].AsInteger  := grdPackagesDBBandedTableView1.Columns[CDESCRIPTION].Position.ColIndex ;
  mtUserProp.Fields.Fields[51].AsInteger  := grdPackagesDBBandedTableView1.Columns[cSUPPLIERCODE].Position.ColIndex ;
  mtUserProp.Fields.Fields[52].AsInteger  := grdPackagesDBBandedTableView1.Columns[cPACKAGENO].Position.ColIndex ;
  mtUserProp.Fields.Fields[53].AsInteger  := grdPackagesDBBandedTableView1.Columns[cTotalPcs].Position.ColIndex ;
...
//  else
//  if dmsProduct.CSD = 2 then
  AddPkgsToSSPLoadFromPkgEntry(Sender)
//   else
//   if dmsProduct.CSD = 3 then
//    AddPkgsToCSDLoadFromPkgEntryTEMP(Sender)
//   else
//   if dmsProduct.CSD = 4 then
//    AddPkgsToSSPLoadFromPkgEntryTEMP(Sender) ;
End ;
...
begin
 ...
 While Not dmsProduct.mtPackages.Eof do
  Begin
   dmsProduct.mtLO_Records.Filter:= 'SupplierShipPlanObjectNo = '+dmsProduct.mtPackages.Fields[cdefsspno].AsString ; //LoadDetailNo
  ...
  if dmsProduct.mtPackages.Fields[cPACKAGETYPENO].AsInteger > 0 then
   Begin
    ...
    Begin
     ...
     sq_OnePkgDetailData.ParamByName('PackageNo').AsInteger:= dmsProduct.mtpackages.Fields.Fields[cPACKAGENO].AsInteger ;
     sq_OnePkgDetailData.ParamByName('SupplierCode').AsString:= Trim(dmsProduct.mtpackages.Fields.Fields[cSUPPLIERCODE].AsString) ;
     sq_OnePkgDetailData.Open ;
     if not sq_OnePkgDetailData.Eof then
     Begin
      cds_LoadPackagesShippingPlanNo.AsInteger        := dmsProduct.mtLO_RecordsLO_NUMBER.AsInteger ;
...
//      cds_LoadPackagesNOOFPKG.AsInteger               := 1 ;
      ...
      cds_LoadPackagesOverrideRL.AsInteger            := dmsProduct.mtPackages.FieldByName('OverrideRL').AsInteger ;
//      cds_LoadPackagesDefaultCustShipObjectNo.AsInteger := dmsProduct.mtPackages.FieldByName('OverrideRL').AsInteger ;
      cds_LoadPackagesDefsspno.AsInteger               := dmsProduct.mtPackages.FieldByName('defsspno').AsInteger ;
//      cds_LoadPackagesProductCategoryNo.AsInteger     := sq_OnePkgDetailDataProductCategoryNo.AsInteger ;
...
procedure TfrmPackageEntry.AddPkgsToCSDLoadFromPkgEntryTEMP(Sender: TObject);
var
  Save_Cursor     : TCursor;
begin
  Save_Cursor       := Screen.Cursor;
  ...
  dmLoadEntryCSDTEMP.ds_LoadPackages2.DataSet:= Nil ;// .mtLoadPackages.DataSource
  try
    { Do some lengthy operation }
 dmsProduct.mtPackages.First ;
 While Not dmsProduct.mtPackages.Eof do
...
//      cds_LoadPackagesProductCategoryNo.AsInteger     := sq_OnePkgDetailDataProductCategoryNo.AsInteger ;
 ...
 End ; //while
  ...
  dmsProduct.mtPackages.Active:= True ;
    ...
    dmsProduct.mtpackages.EnableControls ;
    dmLoadEntryCSDTEMP.ds_LoadPackages2.DataSet:= dmLoadEntryCSDTEMP.cds_LoadPackages ;
    dmsProduct.mtLO_Records.Filtered:= False ;
    Screen.Cursor := Save_Cursor;  { Always restore to normal }
  end;
end;
...
//    bcStdLenGrp.Enabled:= True ;
   ...
   if cbInputOption.ItemIndex = INPUT_LOPM_TOTAL_LOPM then
   Begin
...
//    bcStdLenGrp.Enabled:= False ;
   ...
   if cbInputOption.ItemIndex = INPUT_LOPM_AVERAGE_LENGTH then
   Begin
    bcLengthOption.Enabled:= False ;
    lcLengthGroup.Enabled             := False ;
//    bcStdLenGrp.Enabled:= False ;
   ...
   if cbInputOption.ItemIndex = INPUT_ARTICLES then
   Begin
    bcLengthOption.Enabled:= False ;
//    bcStdLenGrp.Enabled:= False ;
    lcLengthGroup.Enabled             := False ;
...
(*
procedure TfrmPackageEntry.grdPkgsTaBortCustomDrawCell(Sender: TObject;
...
//       mLog.Lines.Add('Paketnr '+IntToStr(PkgNo)+'finns redan') ;
      ...
      End
        ...
        if PackageNumberExists(PkgNo, SupplierCode) = True then
        Begin
         Result:= False ;
        End
         else
          if dmsSystem.Pkg_Reserved(
           PkgNo,
            SupplierCode, Self.Name, Res_UserName) = ThisUser.UserName+'/'+Self.Name { NO_USER_HAS_THIS_PACKAGE_RESERVED }then
             Result:= True
              else
               Result:= False ;
 End ; //with
...
procedure TfrmPackageEntry.FyllTommaPaket (Sender: TObject;Var NoOfErrorPkgnr : Integer) ;
Var x, NoOfPkgNo, CurrentPkgNo : Integer ;
begin
 NoOfPkgNo:= 0 ;
 NoOfErrorPkgnr:= 0 ;
 With dmsProduct do
 Begin
  ...
  Try
   ...
   Begin
    CurrentPkgNo:= 0 ;
    CurrentPkgNo:= dmsConnector.GetCurrentPkgNo(mtUserPropVerkNo.AsInteger, NoOfPkgNo) ;
//    integer(bcMatPunktAgare.Properties.Items.Objects[bcMatPunktAgare.ItemIndex]), NoOfPkgNo) ;
    ...
    Begin
      ...
      Begin
       While (mtpackages.Fields[cPACKAGENO].AsInteger > 0) and (not mtpackages.Eof) do
        mtpackages.Next ;
...
procedure TfrmPackageEntry.LaggUppPaketMedPaketNr(Sender: TObject; Var NoOfErrorPkgnr : Integer; const AntalPaketAttLaggaUpp : Integer) ;
Var     StartPkgNo, PkgNo : Integer ;
        ResultButton : word ;
        Save_Cursor:TCursor;
        Res_UserName : String ;
begin
 ...
 Begin
  ...
  Try
    ...
    Begin
     ...
     Screen.Cursor := crSQLWait;    { Show hourglass cursor }
     Try
      StartPkgNo:= dmsConnector.GetCurrentPkgNo(mtUserPropVerkNo.AsInteger, AntalPaketAttLaggaUpp) ;
//      integer(bcMatPunktAgare.Properties.Items.Objects[bcMatPunktAgare.ItemIndex]), AntalPaketAttLaggaUpp) ;

      if StartPkgNo > 0 then
      Begin
      For PkgNo := StartPkgNo to (StartPkgNo+(AntalPaketAttLaggaUpp-1)) do
      Begin
      ...
      End
        ...
        Begin
         if dmsSystem.Pkg_Reserved(
          ...
          begin
           Try
            if {(PkgNo = StartPkgNo) and } (mtpackages.Fields.Fields[cPACKAGENO].AsInteger < 1) then
             mtpackages.Edit
              else
               mtpackages.Insert ;
...
begin
 if ((bcLengthOption.ItemIndex=0) or (bcLengthOption.ItemIndex=1) or (bcLengthOption.ItemIndex=3)) then
...
begin
 ...
 Begin
  ...
  Try
  ColumnWidth         := grdPackagesDBBandedTableView1.Columns[FirstLengthColumnInmatningViaLast].Width ;
  ...
  For x := mtPackages.FieldCount - 1 downto FirstLengthColumnInmatningViaLast do
  Begin
   mtPackages.Fields.Remove(mtPackages.Fields.Fields[x]) ;
...
begin
 With dmsProduct do
 Begin
  acAddSpecialLengths.Enabled:= (mtPackages.Active) and (mtPackages.RecordCount = 0) ;
 End ;
end;
...
{   if Length(Trim(mtpackages.Fields[cPACKAGENO].AsString)) = 0 then //PCS
  ...
  if OKToSave = False then
   ...
   if (InputOption = INPUT_LOPM_AVERAGE_LENGTH) or (InputOption = INPUT_LOPM_TOTAL_LOPM) then
   Begin
     ...
     Begin
      if MessageDlg('Alla paket sparade OK, vill du lägga paketen till lasten?',
...
//        Close ;
   ...
   End //if InputOption <> INPUT_PIECES then
    ...
    if InputOption = INPUT_PIECES then
    Begin
     if SaveImportedPackages(savetoprodlogg,
     mtUserPropVerkNo.AsInteger,
...
//        Close ;
   ...
   if (InputOption = INPUT_ARTICLES) then
   Begin
...
begin
 With dmsProduct do
 Begin
  acPkgNoSerie.Enabled  := (mtPackages.Active) and (mtPackages.RecordCount > 0) ;
 End ;
end;
...
Var AntalPaketAttLaggaUpp, NoOfErrorPkgnr : Integer ;
 MessageDlgAnswer : Word ;
...
begin
 With dmsProduct do
 Begin
  acFillEmptyPkgNos.Enabled  := (mtPackages.Active) and (mtPackages.RecordCount > 0) ;
 End ;
end;
...
begin
 ...
 Begin
  ...
  cds_RegPoint.ParamByName('ClientNo').AsInteger  := mtUserPropVerkNo.AsInteger ;
...
(*
procedure TfrmPackageEntry.AddPkgsToSSPLoadFromPkgEntryTemp(Sender: TObject);
var
  Save_Cursor : TCursor;
begin
  Save_Cursor       := Screen.Cursor;
  ...
  dmLoadEntrySSPTemp.ds_LoadPackages2.DataSet:= Nil ;// .mtLoadPackages.DataSource
  try
    { Do some lengthy operation }
 dmsProduct.mtPackages.First ;
 While Not dmsProduct.mtPackages.Eof do
...
//      cds_LoadPackagesProductCategoryNo.AsInteger     := sq_OnePkgDetailDataProductCategoryNo.AsInteger ;
 ...
 End ; //while
  ...
  dmsProduct.mtPackages.Active:= True ;
    ...
    dmsProduct.mtpackages.EnableControls ;
    dmLoadEntrySSPTemp.ds_LoadPackages2.DataSet:= dmLoadEntrySSPTemp.cds_LoadPackages ;
    dmsProduct.mtLO_Records.Filtered:= False ;
    Screen.Cursor := Save_Cursor;  { Always restore to normal }
  end;
end;
